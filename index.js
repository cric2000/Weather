      ...
      try {
          if(navigator.geolocation){
               navigator.geolocation.getCurrentPosition(positonData=>{
                  ...
                  let unit="imperial";
                  const webApi = ` https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=af79f5179395082b2202446d6a3b9902&units=`+unit ;
                  fetch(webApi)
                  .then(data=>{
                      return data.json();
                  })
